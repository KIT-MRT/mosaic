...
def get_discrete_centerline(
    ...
    route_plan, _path_found = graph_search.search(roadblock_window[-1])
...
def get_starting_lane(
    ...
    """
    starting_lane: Optional[LaneGraphEdgeMapObject] = None
    on_route_lanes, heading_error = _get_intersecting_lanes(
        ego_state, drivable_area_map, route_lane_dict
    )
